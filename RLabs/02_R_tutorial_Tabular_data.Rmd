...
you have loaded `tidyverse` into R using `library()`. The line `libary(tidyverse)`
...
`AfricaData` that only includes data for
countries in Africa via the `filter()` function. What is the sum of the
