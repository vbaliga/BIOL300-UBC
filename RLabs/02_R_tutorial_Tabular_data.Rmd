...
recorded information about yourselves. You will now use
...
encounter the file (remember that `snake_case` or `camelCase` are
preferred conventions). If any data are missing (e.g., the person chose to
not record a value), leave the corresponding cell blank. Save the data as a `.csv` file in the `DataForLabs` folder on your computer with the file name
