...
<br> 2. For each week, create an R script that captures the code that
you use to answer the questions, along with the answers. Use a `#` at
...
would be appropriate to use in R. Remember that `camelCase` and
`snake_case` are usually good conventions.
